...
const translations = {
  en: {
    ...
    actionItemsTableHeaderPriority: 'Priority',
    ...
    exportModalTitle: 'Export Report & Choose Template',
    exportModalSubtitle: 'Select document template and output format suited to your needs.',
    templateTitle: '1. Select Document Template',
    templateStandardTitle: 'Minutes of Meeting tiêu chuẩn',
    templateStandardBadge: 'Standard MoM',
    templateStandardDesc: 'Full standard format: Overview, Objectives, Discussion Summary, Decisions, Action Items table, Notes & Transcript.',
    templateSummaryTitle: 'Bản tóm tắt ngắn gọn',
    templateSummaryBadge: 'Executive Brief',
    templateSummaryDesc: 'Concise summary for managers: High-level overview, key decisions, and critical action items.',
    templateTechnicalTitle: 'Bản chi tiết kỹ thuật',
    templateTechnicalBadge: 'Technical Report',
    templateTechnicalDesc: 'In-depth engineering report: Technical specifications, decisions, blockers/issues, and full transcript.',
    exportFormatTitle: '2. Select Output Format & Method',
    formatDocx: 'Word Document (.docx)',
    formatXlsx: 'Excel Spreadsheet (.xlsx)',
    formatGmail: 'Create Gmail Draft',
    formatDrive: 'Save to Google Drive',
    exportOptionsTitle: '3. Additional Options',
    optionIncludeTranscript: 'Include Full Meeting Transcript Appendix',
    btnExportNow: 'Export Report Now',
    cancel: 'Cancel',
  ...
  vi: {
    ...
    actionItemsTableHeaderPriority: 'Mức độ ưu tiên',
    ...
    exportModalTitle: 'Tùy chọn xuất báo cáo & Mẫu văn bản',
    exportModalSubtitle: 'Chọn template tài liệu và định dạng xuất phù hợp nhất với nhu cầu của bạn.',
    templateTitle: '1. Chọn Mẫu Văn bản (Template)',
    templateStandardTitle: 'Minutes of Meeting tiêu chuẩn',
    templateStandardBadge: 'Biên bản tiêu chuẩn',
    templateStandardDesc: 'Đầy đủ các mục tiêu chuẩn: Tổng quan, Mục tiêu, Tóm tắt thảo luận, Quyết định, Bảng công việc và Phụ lục.',
    templateSummaryTitle: 'Bản tóm tắt ngắn gọn',
    templateSummaryBadge: 'Tóm tắt cho Quản lý',
    templateSummaryDesc: 'Cô đọng, súc tích dành cho cấp quản lý: Tổng quan cao cấp, quyết định then chốt & công việc quan trọng.',
    templateTechnicalTitle: 'Bản chi tiết kỹ thuật',
    templateTechnicalBadge: 'Báo cáo Kỹ thuật',
    templateTechnicalDesc: 'Báo cáo chuyên sâu kỹ thuật: Chi tiết thảo luận công nghệ, rủi ro/tồn đọng & nhật ký cuộc họp.',
    exportFormatTitle: '2. Chọn Định dạng & Phương thức xuất',
    formatDocx: 'Văn bản Word (.docx)',
    formatXlsx: 'Bảng tính Excel (.xlsx)',
    formatGmail: 'Tạo nháp Gmail',
    formatDrive: 'Lưu vào Google Drive',
    exportOptionsTitle: '3. Tùy chọn bổ sung',
    optionIncludeTranscript: 'Đính kèm Phụ lục Nhật ký chi tiết cuộc họp (Transcript)',
    btnExportNow: 'Xuất báo cáo ngay',
    cancel: 'Hủy',
